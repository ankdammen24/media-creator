...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Catalogus Musicus: music catalog and live radio." },
      ...
      { property: "og:description", content: "Catalogus Musicus: music catalog and live radio." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Catalogus Musicus" },
      { name: "twitter:description", content: "Catalogus Musicus: music catalog and live radio." },
