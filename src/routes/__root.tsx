...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Media Rosenqvist" },
      { name: "description", content: "Media Rosenqvist: music catalog and live radio." },
      { name: "author", content: "Media Rosenqvist" },
      { property: "og:title", content: "Media Rosenqvist" },
      { property: "og:description", content: "Media Rosenqvist: music catalog and live radio." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Media Rosenqvist" },
      { name: "twitter:description", content: "Media Rosenqvist: music catalog and live radio." },
