  ...
  return (
    <div className="flex h-full flex-col p-4">
      <div className="mb-6 px-2">
        <Link to="/dashboard" className="block text-xl font-semibold" onClick={onNavigate}>
          Media Creator
        </Link>
      ...
      <nav className="flex flex-1 flex-col gap-1">
        {NAV.map(({ to, label, icon: Icon }) => (
          <Link
            ...
            to={to}
            onClick={onNavigate}
            className="group flex items-center gap-3 rounded-md px-3 py-2 text-sm text-sidebar-foreground hover:bg-sidebar-accent"
            activeProps={{
              className: cn(
      ...
      <div className="mt-4 border-t border-sidebar-border pt-4">
        ...
        <div className="flex items-center gap-2 px-1">
          ...
          <button
            type="button"
            onClick={onLogout}
            className="ml-auto inline-flex items-center gap-1 rounded-md px-2 py-1 text-xs text-muted-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground"
          >
